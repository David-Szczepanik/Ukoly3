...
namespace ClassRoom {
    internal class TestClass {
        static void Main(string[] args) {
            ...
            Teacher t1 = new Teacher("Učitel 1", 40);
            Teacher t2 = new Teacher("Učitel 2", 50);
            ...
            Console.WriteLine("--Ucitel z druhe tridy--");
            Console.WriteLine(cr2.GetTeacherName());
            Console.WriteLine("\n--Treti student z druhe tridy--");
            //Třetí student
            Console.WriteLine(cr2.GetStudent(2));
        }
    }
}
